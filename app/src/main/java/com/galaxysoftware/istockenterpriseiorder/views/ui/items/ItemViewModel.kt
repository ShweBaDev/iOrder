...
class ItemViewModel : ViewModel() {
    ...
    fun loadData() : LiveData<List<UsrCode>>{
        ...
        if(result == null)
        {
                ...
                parameter.add(ParameterHelper(PsqlParameterName = "_usercode" , PsqlDbTypes = NpgsqlDbType.Varchar.value,PsqlParameterDirection = ParameterDirection.Input.value,PsqlParameterValue = null))
